...
import {
  selectSvgElement
} from "./chunk-JNSUQTQZ.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-2Y2P7E6G.js";
import {
  registerLayoutLoaders
} from "./chunk-CYMN64MW.js";
import "./chunk-YJ3BXAD2.js";
import "./chunk-ZIJMJPLQ.js";
import "./chunk-ZXDETG2Y.js";
import "./chunk-QPRI47DD.js";
import "./chunk-YHLHJUSQ.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-4TUYGLN4.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-FPNF74CW-KESMOYZY.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-PVAE7QVJ-5ANVZ2EM.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-AWTI2OKA-FF7WQLYV.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-NY62KEGX-ELL5F4VY.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-OWAHRB6G-4CVTSVQS.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-STP46IZ2-QANATUCI.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-ADFJNKIX-IEKD2HLE.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-LMRXKWRM-TAVWXXOZ.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-6GGTOJPD-UGFRRPQE.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-4UW4RH46-PUNUALQO.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-C3RYC4MD-MFGUGPUU.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-KNZD7YFC-VBU3USGU.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-RKCZMP56-V5NFT6SR.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-KXAO66HF-RUNE6PLM.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-UMBNRL4Z-IFNXXAMW.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-BIP6EPQ6-ASN4WLAC.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-XQNQX7LJ-FC6XFTMU.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-Q6HEUPPD-W2YIZSJA.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-6OIFK2YF-GT2IJ2XJ.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-GR3RE2ED-APJFWOKS.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-S2PKOQOG-ETSLBEDD.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-QEK2KX5R-JBDKBUHD.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-QIGZ2CNN-M5Z5SFAO.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-W76B3OCA-QSPN33FD.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-N5W7TBWH-OKUCBZAY.js");

...
export default {
    meta: {
        ...
        messages: {
            duplicateDefinition: "Unexpected duplicate definition `{{ identifier }}` found.",
            duplicateFootnoteDefinition: "Unexpected duplicate footnote definition `{{ identifier }}` found.",
        },
        schema: [
            {
                type: "object",
